"""wfi2mask — detecção automática de água em imagens WFI.

Máscaras d'água a partir de imagens dos sensores WFI dos satélites
brasileiros CBERS-4, CBERS-4A e Amazonia-1, usando o algoritmo de Matiz
(Hue) de Namikawa et al. (2016) aprimorado com filtros NDWI, HAND e NIR.
